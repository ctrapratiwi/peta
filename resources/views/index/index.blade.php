...
<title>Peta Persebaran Covid-19</title>

<meta name="viewport" content="width=device-width,initial-scale=1,shrink-to-fit=no" />
<link rel="stylesheet" type="text/css" href="{{ secure.asset('css/index.css')}}" />
...
<div class="container-fluid">
	<div class="row header">
        ...
        <div class="row col-lg-1">
            <a class="admin" href="/pasien">Tambah Data</a>
        </div>
        	...
        	<div class="box2">
                ...
                <form action="/search" method="post" id="form">
                  ...
                  <div class="form-group">
                    <label for="from" >Masukkan Tanggal Penyebaran :</label>
        ...
        <div class="row info">
        	...
        	<div class="card" style="width: 80rem;">
              ...
              <div class="row">
                <div class="col-6">
                  Color Start
                  <input type="color" value="#128EAB" class="form-control" id="colorStart">
                </div>
                <div class="col-6">
                  Color End
                  <input type="color" value="#D9F5FB" class="form-control" id="colorEnd">
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-12">
                  <button class="btn btn-default form-control" id="btnGenerateColor">Generate Color</button>
                </div>
        ...
        onKMZLoaded: function (layer, name) {
          ...
          if(!Array.isArray(dataMap) || !dataMap.length == 0 ){
            ...
            var data = '<table width="300">';
              ...
              data +='  <tr style="color:maroon">';
              data +='    <td>Meninggal</td>';
              data +='    <td>: '+dataMap[index].meninggal+'</td>';
              data +='  </tr>';


              data +='  <tr style="color:orange">';
              data +='    <td>Masih Dirawat</td>';
